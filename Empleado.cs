    ...
    public class Empleado
    {
                ...
                using (DL.JSanchezCRUDJavaScripEntities context = new DL.JSanchezCRUDJavaScripEntities())
                {
                    ...
                    if (empleadoItem.Count > 0)
                    {
                        ...
                        foreach (var empleadoItems in empleadoItem)
                        {
                            ...
                            empleado.Estado.Id = empleadoItems.IdEstado.Value;
                            empleado.Estado.Estado = empleadoItems.Estado;
            ...
            try
            {
                using (DL.JSanchezCRUDJavaScripEntities context = new DL.JSanchezCRUDJavaScripEntities())
                {
                    ...
                    if (empleadoItem != null)
                    {
                        ...
                        empleado.Estado = new ML.CatEntidadFederativa();
                        empleado.Estado.Id = empleadoItem.IdEstado.Value;
                        empleado.Estado.Estado = empleadoItem.Estado;
        ...
        public static ML.Result Add(ML.Empleado empleado)
        {
            ...
            try
            {
                using (DL.JSanchezCRUDJavaScripEntities context = new DL.JSanchezCRUDJavaScripEntities())
                {
                    var empleadoItem = context.EmpleadoAdd(empleado.NumeroNomina,empleado.Nombre,empleado.ApellidoPaterno,empleado.ApellidoMaterno,empleado.Estado.Id);
        ...
        public static ML.Result Update(ML.Empleado empleado)
        {
            ...
            try
            {
                using (DL.JSanchezCRUDJavaScripEntities context = new DL.JSanchezCRUDJavaScripEntities())
                {
                    var empleadoItem = context.EmpleadoUpdate(empleado.Id,empleado.NumeroNomina,empleado.Nombre,empleado.ApellidoPaterno,empleado.ApellidoMaterno,empleado.Estado.Id);
