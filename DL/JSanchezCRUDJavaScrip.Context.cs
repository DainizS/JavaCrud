...
namespace DL
{
    ...
    public partial class JSanchezCRUDJavaScripEntities : DbContext
    {
        public JSanchezCRUDJavaScripEntities()
            : base("name=JSanchezCRUDJavaScripEntities")
        {
        }
        ...
        public virtual ObjectResult<CatEntidadFederativaGetById_Result> CatEntidadFederativaGetById(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CatEntidadFederativaGetById_Result>("CatEntidadFederativaGetById", idParameter);
        }
    
        public virtual int EmpleadoUpdate(Nullable<int> id, string nombre, string apellidoPaterno, string apellidoMaterno, Nullable<int> idEstado)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EmpleadoUpdate", idParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, idEstadoParameter);
        }
    }
}
